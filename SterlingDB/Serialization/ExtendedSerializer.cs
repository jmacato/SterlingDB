    ...
    internal class ExtendedSerializer : BaseSerializer
    {
        ...
        public ExtendedSerializer(ISterlingPlatformAdapter platformAdapter)
        {
            ...
            _serializers.Add(typeof(DateTime), new Tuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
                ...
                br => { return new DateTime(br.ReadInt64(), (DateTimeKind) br.ReadInt32()); }));
        ...
        {
            if (!CanSerialize(target.GetType())) throw new SterlingSerializerException(this, target.GetType());
        ...
        {
            if (!CanSerialize(type)) throw new SterlingSerializerException(this, type);
